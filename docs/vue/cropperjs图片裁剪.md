...
<script>
    ...
    import {uploadImg} from "@/api/setting/pageSetting";
    ...
    export default {
        ...
        methods: {
            ...
            async upload(file) {
                ...
                let form;
                let getToekn = await getUpToken({key});

                if (getToekn.error == 0 && getToekn.data) {
                    form = {key: key, token: getToekn.data.uptoken, file};
                } else {
            ...
            changeQuality() {
                ...
                // 圆形
                croppedCanvas = this.isCircle ? this.getRoundedCanvas(croppedCanvas) : croppedCanvas;
...
<style>
    ...
    .operation .btn-rotate-left {
        ...
        background-image: url("../../assets/setting/rotate-left.png");
    }
    ...
    .operation .btn-l {
        background-size: 60% 60%;
        background-image: url("../../assets/setting/l.png");
    }

    .operation .btn-v {
        background-size: 60% 60%;
        background-image: url("../../assets/setting/v.png");
    }

    .operation .btn-reset {
        background-size: 60% 60%;
        background-image: url("../../assets/setting/reset.png");
    }
